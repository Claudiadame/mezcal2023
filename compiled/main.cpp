...
std::cout << "\n5. Salir\n" << std::endl;
std::cout << "Ingresa una opcion del 1-5: " << std::endl;
	 std::cin >> Opc;
while(Opc!=5){
if(Opc==1){
	 int numero;
...
std::cout << "\nEl numero mayor es: " << mayor << std::endl;std::cout << "\nEl numero menor es: " << menor << std::endl;std::cout << "" << std::endl;
}
else if(Opc==3){
	 int menor;
	 int numero;
	 int temporal;
int Array[10];
std::cout << "Ingresa 10 numeros\n" << std::endl;
for(int i=0;i<=9;i=i+1){
std::cout << "Dame el numero" << std::endl;
	 std::cin >> numero;
Array[i]=numero;
}
std::cout << " " << std::endl;
...
std::cout << " " << std::endl;
std::cout << "Arreglo Ordenado de Menor a Mayor" << std::endl;
std::cout << " " << std::endl;
