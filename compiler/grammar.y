...
%token  NAME COLON RIGHT_ARROW LEFT_CURLY_BRACE RIGHT_CURLY_BRACE SEMICOLON LEFT_PARENTHESIS RIGHT_PARENTHESIS SINGLECOMMENT
        ...
        CORCH_IZQ CORCH_DERECHO EQ LE LT GT GE NE ELSE COMA STR DOBLE_COLON WHILE ANSWER ADD DOB_SLASH_IN LES SLASH SEARCH CDE
...
std_output:
	CDE COLON characters_block	{ $$ = "std::cout << " + $3 + ";"; }
	|
